<div>
     <x-backend.shared.page-nav>
          <x-slot:title>
               {{ Settings::trans('Add New Project','پروژه اضافه کړئ','پروژه اضافه کنید') }}
          </x-slot:title>
          ...
          <li class="breadcrumb-item active">{{ Settings::trans('Add New Project','پروژه اضافه کړئ','پروژه اضافه کنید') }}</li>
     </x-backend.shared.page-nav>
