<div>
     <x-backend.shared.page-nav>
          <x-slot:title>
               {{ Settings::trans('Edit Fund','د وجهی تصحیح','تصحیح وجه') }}
          </x-slot:title>
          ...
          <li class="breadcrumb-item active"> {{ Settings::trans('Edit Fund','د وجهی تصحیح','تصحیح وجه') }}</li>
     </x-backend.shared.page-nav>
     <x-backend.shared.page-container>
               ...
               <div class="row m-0 p-0">
                    ...
                    <x-input 
                         name="fund_componenet_code" 
                         id="fund_componenet_code" label="{{ Settings::trans('Fund Component','د وجهی اجزا','اجزا وجه') }}"
                         placeholder="{{ Settings::trans('Fund Component','د وجهی اجزا','اجزا وجه') }}"
                         wire:model="fund_componenet_code" 
                         type="number" 
                         col="col-sm-3" /> 
