<div>
     <x-backend.shared.page-nav>
          <x-slot:title>
               {{ Settings::trans('Add New Object','نوی باب اضافه کړئ','باب جدید اضافه کنید') }}
          </x-slot:title>
          ...
          <li class="breadcrumb-item active">{{ Settings::trans('Add New Object','نوی باب اضافه کړئ','باب جدید اضافه کنید') }}</li>
     </x-backend.shared.page-nav>
     <x-backend.shared.page-container>
               ...
               <div class="row m-0 p-0">
                    ...
                    <x-input 
                         name="new_code" 
                         id="new_code" label="{{ Settings::trans('Object','فصل','فصل') }}"
