<div>
     <x-backend.shared.page-nav>
          <x-slot:title>
               {{ Settings::trans('Add New Measurement Unit','د قیاس واحد اضافه کړئ','واحد قیاس اضافه کنید') }}
          </x-slot:title>
          ...
          <li class="breadcrumb-item active">{{ Settings::trans('Add New Measurement Unit','د قیاس واحد اضافه کړئ','واحد قیاس اضافه کنید') }}</li>
     </x-backend.shared.page-nav>
