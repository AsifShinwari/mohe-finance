...
@section('page_title')
{{ Settings::trans('Edit CF','د CF تصحیح کول','تصحیح کردن CF') }}
@endsection
...
@section('page_nav')
    ...
    <li class="breadcrumb-item"><a>{{ Settings::trans('Edit CF','د CF تصحیح کول','تصحیح کردن CF') }} {{ substr(Settings::change_to_hijri($budget_plan->year),0,4) }}</a></li>
@endsection
    ...
    <form id="frm-add">
        <div class="row m-0 p-4">
            ...
            <x-select 
                ...
                value="code"
                text="code"
                selected_value="{{ $cf->code_project_6 }}"
            ...
            <x-select 
                ...
                value="activity_code"
                text="activity_code"
                selected_value="{{ $cf->code_program_5 }}"
            ...
            <x-select 
                ...
                value="dist_code"
                text="dist_code"
                selected_value="{{ $cf->code_location_4 }}"
            ...
            <x-select 
                ...
                value="major_code"
                text="major_code"
                selected_value="{{ $cf->code_object_2 }}"
...
@push('scripts')
    <script>
        ...
        $('#frm-add').submit(function(e){
            ...
            $.ajax({
                url: "{{ route('finance.budget.dev.plan.cf.update',$cf->id) }}",
                type: 'POST',
