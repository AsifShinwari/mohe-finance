        ...
        <thead class="text-center">
            <tr>
                ...
                <td rowspan="5" style="border-right: 0px !important;vertical-align:middle;" class="text-center">
                    ...
                    <p class="mb-0">{{ Settings::trans('Budget Plan Form (B20)','د انکشافي بودیجی پلان فورم (B20)','فورم بودجه انکشافی مالی (B20)') }}</p>
                </td>
                ...
                <td>{{ $budget_plan->dev_b20_form_no }}</td>
                <td>{{ Settings::trans('Year','مالي کال','سال مالی') }}</td>
                <td>{{ substr(Settings::change_to_hijri($budget_plan->year),0,4) }}</td>
            </tr>
            <tr>
                <td>{{ Settings::trans('Development Budget Manager','د انکشافي بودیجی عمومي مدیر','مدیر عمومی بودجه انکشافی') }}</td>
                ...
                <td colspan="3" rowspan="2">{{ $budget_plan->dev_b20_beu_no }}</td>
            </tr>
            <tr>
                <td>{{ $budget_plan->dev_b3_gnrl_bgt_mgr }}</td>
                <td>{{ $budget_plan->dev_b3_gnrl_drctr }}</td>
                <td>{{ $budget_plan->dev_b20_sending_no }}</td>
            </tr>
            <tr>
                ...
                <td rowspan="2" colspan="3">{{ $budget_plan->dev_b20_afmis_no }}</td>
            </tr>
            <tr>
                <td>{{ $budget_plan->dev_b20_sending_date }}</td>
            </tr>
        </thead>
    </table>
    <table class="table table-sm table-bordered" id="main-tbl">
        <thead id="tbl-head">
            <tr>
                ...
                <td colspan="8">{!! $budget_plan->dev_b20_needs_in_letters !!}</td>  
                ...
                <td colspan="6">{!! $budget_plan->dev_b20_prescription_gnrl_drctr !!}</td>  
            </tr>
            <tr>
