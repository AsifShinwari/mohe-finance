...
<div class="text-center">
    <p class="mb-0 font-weight-bold">{{ Settings::trans('Development Budget Plan Promises List','د '.substr(Settings::change_to_hijri($budget_plan->year),0,4).' کال د انکشافي بویجی د تعهداتو لیست','تعهدات بودجه انکشافی بخش مصارفات سال مالی'.substr(Settings::change_to_hijri($budget_plan->year),0,4)) }}</p>
</div>
