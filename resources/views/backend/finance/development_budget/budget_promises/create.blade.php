...
@section('page_nav')
    ...
    <li class="breadcrumb-item"><a>{{ Settings::trans('Add Dev Budget Promises','د تعهد اضافه کول','اضافه کردن تعهد') }} {{ substr(Settings::change_to_hijri($budget_plan->year),0,4) }}</a></li>
@endsection
