...
title="{{ Settings::trans('Budget Transfer','د بودیجی تعدیل','تعدیل بودجه') }}">
      <div class="modal-body pt-0">
        <form action="{{ route('finance.budget.dev.plan.b3.print',$budget_plan->id) }}" method="get" id="add-frm">
  ...
  <script>
    ...
    function get_code_amount(){
      ...
      if($('#cr_code_loaction').val()!=''&&
        ...
        $.ajax({
            url: "{{ route('finance.budget.dev.plan.transfers.external.get.code.amount') }}",
            type: "GET",
