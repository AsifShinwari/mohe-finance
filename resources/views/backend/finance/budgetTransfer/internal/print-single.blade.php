...
<table class="table table-sm table-bordered">
    <thead class="bg-light">
        <tr>
            <th colspan="10" class="text-center">
                {{ Settings::trans('Budget Plan Transfer From','د ب ۲۳ فورم (FB-B23 د مالي پلان تعدیل)','فورمه ب ۲۳ (FB-B23 تعدیل پلان مالی)') }}
            </th>
        </tr>
        <tr>
    ...
    <tbody>
        <tr class="bg-light">
            <td rowspan="2">{{ Settings::trans('Org(5)','وزارت(۵)','وزارت(۵)') }}</td>
            ...
            <td rowspan="2">{{ Settings::trans('Type(1)','نوع(۱)','نوع(۱)') }}</td>
        ...
        <tr class="text-primary">
            ...
            <td>{{ $transfer->b20_code_loaction }}</td>
            <td>{{ $transfer->b20_code_object_2 }}</td>
            <td>{{ $transfer->b20_code_cate_1 }}</td>
